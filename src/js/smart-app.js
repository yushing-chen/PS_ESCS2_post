...
//https://vaww.esrstage1a.aac.va.gov/es-rs/ratingapp/postform      
//https://vaausappesr801.aac.va.gov:7401/es-rs/ratingapp/postform         
      var es_data = '{"parameters":{' +
      '"edipi":"'      + edipi +'",'+
      '"icn":"'        + icn +'",'+
      '"name":"'       + nm +'",'+
      '"dob":"'        + dobStr +'",'+
      ...
      '"mrn":"'        + mrn + '"}}';
      var status="";
      var es_url = "https://vaww.esrstage1a.aac.va.gov/es-rs/ratingapp/postform";
      		console.log(es_url + es_data );
      		alert(es_url + es_data);
      		$.post(es_url, es_data, status); 
